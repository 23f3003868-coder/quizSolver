#!/usr/bin/env python3
"""
Test script to send a POST request to the deployed quiz solver service with the sample demo URL
"""
import asyncio
import json
import httpx
...
async def test_quiz_solver_with_sample_demo():
    print("Testing deployed quiz solver service with sample demo URL...")
    ...
    async with httpx.AsyncClient(timeout=60) as client:
        try:
            ...
            if response.status_code == 200:
                print("\n✅ Request successful! The quiz solver should now process the sample demo quiz in the background.")
...
if __name__ == "__main__":
    asyncio.run(test_quiz_solver_with_sample_demo())